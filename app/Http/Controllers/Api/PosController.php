...
class PosController extends Controller
{
    ...
    public function OrderDone(Request $request){
     ...
     $data['tempcustomername'] = $request->tempcustomername;
   ...
   public function SearchOrderDate(Request $request){
    ...
    public function AllSell(){
      ...
      $allsell = DB::table('orders')->sum('total');
    ...
    public function AllDue(){
      ...
      $alldue = DB::table('orders')->sum('due');
      return response()->json($alldue);
    }
    ...
    public function AllExpense(){
       ...
       $allexpense = DB::table('expenses')->sum('amount');
