...
let forgatepassword =require('./components/auth/forgatepassword.vue').default;
...
let storesubcategory = require('./components/subcategory/create.vue').default;
...
export const routes = [
	...
	{ path: '/forgatepassword', component: forgatepassword, name:'forgatepassword' },
	...
	// Sub-Category Routes
	{ path: '/store-subcategory', component: storesubcategory, name:'store-subcategory'},
	{ path: '/subcategory', component: subcategory, name:'subcategory'},
	{ path: '/edit-subcategory/:id', component: editsubcategory, name:'edit-subcategory'},
