   ...
   <div class="container-fluid" id="container-wrapper">
         ...
         <router-link to="/store-customer" class="btn btn-sm btn-info"><font color="#ffffff">Add Customer</font></router-link>         
          ...
          <tr v-for="cart in carts" :key="cart.id">
            <td style="width: 40px;">{{ cart.pro_name }}</td>
  ...
  <strong>{{ subtotal*vats.vat /100 + subtotal}} $</strong>
        ...
        <form @submit.prevent="orderdone">
         ...
         <option :value="customer.id" v-for="customer in customers">{{customer.name }} </option>
           ...
           <input type="text" class="form-control" v-model="tempcustomername">
          <br>
           <label>Pay</label>
...
<div class="card-body">
 <input type="text" v-model="searchTerm" class="form-control" style="width: 662px;" placeholder="Search Product">
  <br>
     <div class="row">
...
<div class="card-body">
<input type="text" v-model="getsearchTerm" class="form-control" style="width: 662px;" placeholder="Search Product">
  <br>
     <div class="row">
...
<script type="text/javascript">
 ...
 data(){
  ...
  orderdone(){
    ...
    var data = {qty:this.qty, subtotal:this.subtotal, customer_id:this.customer_id, tempcustomername:this.tempcustomername, payby:this.payby, pay:this.pay, due:this.due, vat:this.vats.vat, total:total }
