            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
        <div class="text-xs font-weight-bold text-uppercase mb-1">All Sell Amount</div>
 <div class="h5 mb-0 font-weight-bold text-gray-800">$ {{ allsell }}</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> 3.48%</span>
                        <span>Since last month</span>
                      </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
   <div class="text-xs font-weight-bold text-uppercase mb-1">All Due</div>
      <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">$ {{ alldue }} </div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> 20.4%</span>
                        <span>Since last month</span>
                      </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
  <div class="text-xs font-weight-bold text-uppercase mb-1">All Expense</div>
...
<script type="text/javascript">
 ...
 this.StockOut();
  ...
  methods:{
     ...
     AllDue(){
      axios.get('/api/alldue')
        .then(({data}) => (this.alldue = data))
        .catch()
     },
     ...
     AllExpense(){
      axios.get('/api/today/allexpense')
        .then(({data}) => (this.allexpense = data))
        .catch()
     },
