...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forgatepassword' ? false : true " style="display: none;">
      <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/home">
          <div class="sidebar-brand-icon">
            <img src="{{asset('backend/img/logo/logo2.png')}}">
          </div>
          <div class="sidebar-brand-text mx-3">Inventory Pro</div>
        </a>
        <hr class="sidebar-divider my-0">
        <li class="nav-item active">
          <router-link class="nav-link" to="/home">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span style="padding-bottom: 10px;">Dashboard</span></router-link>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <router-link class="collapse-item" to="/store-subcategory">Add Sub-Category</router-link>
              <router-link class="collapse-item" to="/subcategory">All Sub-Category</router-link>
            </div>
          </div>
        </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <!-- TopBar -->
        <nav id="topbar" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forgatepassword' ? false : true " style="display: none;">
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
              <b><a href="http://appsitication.com/" target="_blank">Appsitication</a></b>
            </span>
          </div>
        </div>
      </footer>
